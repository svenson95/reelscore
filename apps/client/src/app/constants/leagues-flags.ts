...
export const LEAGUES_FLAGS = {
  [CompetitionName.ENGLAND_PREMIER_LEAGUE]: '🏴󠁧󠁢󠁥󠁮󠁧󠁿',
  [CompetitionName.GERMANY_BUNDESLIGA]: '🇩🇪',
  [CompetitionName.GERMANY_BUNDESLIGA_2]: '🇩🇪',
  [CompetitionName.ITALY_SERIE_A]: '🇮🇹',
  [CompetitionName.SPAIN_LA_LIGA]: '🇪🇸',
  [CompetitionName.FRANCE_LIGUE_1]: '🇫🇷',

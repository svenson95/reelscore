import { EVALUATIONS_SERVICE_PROVIDER } from './evaluations/evaluations.service';
import { HTTP_EVALUATIONS_SERVICE_PROVIDER } from './evaluations/http.service';
...
export * from './evaluations/evaluations.service';

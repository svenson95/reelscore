...
@Component({
  ...
  styles: `
    :host { @apply flex flex-col mt-rs1 gap-5; }

    .fixture-analyse { @apply p-5 mx-rs1 bg-rs-alt-bg border text-rs-color-text-1 text-rs-font-size-small sm:text-rs-font-size-body-1; }
    .fixture-analyse > div {
